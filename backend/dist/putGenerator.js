...
exports.generatePutAxiosCodeFromSwagger = exports.generatePutAxiosCode = void 0;
...
function generatePutAxiosCode(swaggerFilePath, args) {
            ...
            if (api.paths) {
                for (const [path, pathItem] of Object.entries(api.paths)) {
                    ...
                    if (operation) {
                        ...
                        const example = yield (0, generateValue_1.generateRequestBodyExample)(swaggerFilePath, path, 'put');
                        fileContent += `sendPutRequest('PUT', '${fullUrl}', ${JSON.stringify(headers)}, ${JSON.stringify(example)});\n`;
                    }
                }
            }
            return fileContent;
...
exports.generatePutAxiosCode = generatePutAxiosCode;
// async function main() {
//     try {
...
// }
// main();
function generatePutAxiosCodeFromSwagger(swaggerFilePath, args) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a;
        const api = yield SwaggerParser.parse(swaggerFilePath);
        const securitySchemes = yield (0, auth_1.getSecuritySchemes)(api);
        ...
        for (const [path, pathItem] of Object.entries(api.paths)) {
            ...
            if (operation) {
                ...
                const fullUrl = `${fullPath}${queryString}`;
                const example = yield (0, generateValue_1.generateRequestBodyExample)(swaggerFilePath, path, 'put');
                requests.push(`sendPutRequest('PUT', '${fullUrl}', ${JSON.stringify(headers)}, ${JSON.stringify(example)});`);
            }
        }
        return requests;
    });
}
exports.generatePutAxiosCodeFromSwagger = generatePutAxiosCodeFromSwagger;
